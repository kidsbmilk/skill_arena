...
import com.zz4955.annotation_autowired_ex.pojo.BeanDefine;
...
public class ClassPathXMLApplicationContext {
    ...
    public void readXML(String fileName) {
        ...
        try {
            ...
            for(Iterator<Element> beansIterator = beans.elementIterator(); beansIterator.hasNext(); ) {
     ...
     * 如果注解MyResource没有配置name属性，则根据属性所属类型来扫描配置文件获取要注入的实例引用。
     */
