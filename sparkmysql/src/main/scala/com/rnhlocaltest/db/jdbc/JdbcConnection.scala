package com.rnhlocaltest.db.jdbc

import java.sql.{Connection, DriverManager}
import java.util.Properties

import com.rnhlocaltest.db.jdbc.JdbcDataFrameWriter._
...
/**
  ...
  *
  */
private[db] trait JdbcConnection {
...
private[db] object MysqlConnection {
...
private[db] object PGConnection {
...
private[db] object Db2Connection {
